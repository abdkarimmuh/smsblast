<aside id="sidebar-wrapper">
  ...
  <ul class="sidebar-menu">
      ...
      <li class="{{ Request::route()->getName() == 'admin.permissions' ? ' active' : '' }}"><a class="nav-link" href="{{ route('admin.permissions') }}"><i class="fa fa-users"></i> <span>Permissions</span></a></li>
      @endif
